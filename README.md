...
<img src="./animation.svg" alt="Apple IIc terminal" />
...
### Some notable things I've built

**[Viva Engage Outlook Integration](https://support.microsoft.com/en-US/viva/engage/vivaengage/work-with-viva-engage-from-outlook)** — First-party Outlook "dynamic email" integration allowing interaction with Viva Engage features directly from Outlook   
**[Home Assistant "Quick Bar"](https://www.home-assistant.io/blog/2020/10/28/release-117/#quick-bar)** — A VS Code-like "command palette" for Home Assistant to rapidly find entities and actions across their instance from anywhere, using fuzzy string subsequence matching.

---

<sub><a href="https://linkedin.com/in/">LinkedIn</a> · <a href="https://www.donniekarns.com">Web site</a></sub>
